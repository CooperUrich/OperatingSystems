...
public class SantaScenario {
	...
	public void addReindeerToShed(){
		this.numberOfReindeersAtShed = numberOfReindeersAtShed + 1;
	}
	public int numberOfReindeerInShed(){
		return numberOfReindeersAtShed;
	}
	public void setReadyForChristmas(boolean val){
		this.readyForChristmas = val;
	}
	public boolean getReadyForChristmas(){
		return readyForChristmas;
	}
	public static void main(String args[]){
		...
		scenario.reindeerInShed = new Semaphore(1, true);
		...
		for(int day = 300; day < 500; day++) {
			...
			if (scenario.atShed.size() == 8){
				scenario.reindeerInShed.release();
			}
